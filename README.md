...
🚀 **Live Demo:** [customer-churn-prediction-project-78.streamlit.app](https://customer-churn-prediction-project-78.streamlit.app/)
...
### 🚀 How to Use
1. **Open the App:** Navigate to the [Live Link](https://customer-churn-prediction-project-78.streamlit.app/).
2. **Select a Scenario:** Use the `🔴 HIGH RISK` or `🟢 LOW RISK` buttons to see the model's logic in action.
3. **Customize Data:** Manually adjust the 19 feature inputs to represent any customer profile.
